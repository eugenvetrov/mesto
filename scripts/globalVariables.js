...
const popupCloseProfile = document.querySelector(".popup_profile-close");
...
const popupCloseCard = document.querySelector(".popup_card-close");
...
const popupCloseFullscreen = document.querySelector(".popup_fullscreen-close");
