...
const popupEditProfileName = document.querySelector(
  ".popup__text_profile-name"
);
const popupEditProfileDescription = document.querySelector(
...
const handleLikeCardSucces = (res, cardElement) => {
...
const handleDeleteLikeCard = (cardElement) => {
  api.deleteLikeCard(cardElement.getCardId()).then((res) => {
    handleLikeCardSucces(res, cardElement);
  });
};

const handlePutLikeCard = (cardElement) => {
  api.putLikeCard(cardElement.getCardId()).then((res) => {
    handleLikeCardSucces(res, cardElement);
  });
};
